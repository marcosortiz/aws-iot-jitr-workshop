 ...
 * Attaches a `creation_id` UUID v4 to the payload as
 * well in order to make the thing creation atomic across
 * all the concurrently running Lambda functions.
 * @param {*} attrs an X.509 attributes object.
 */
const normalize = (attrs) => _.assign(_.mapKeys(attrs, (_1, key) => mapping[key] || key), {
  creation_id: UUID.v4()
});
